...
function _wasm_dlopen(...args) {
  abort('missing function: wasm_dlopen')
}
_wasm_dlopen.stub = true
function _wasm_dlsym(...args) {
  abort('missing function: wasm_dlsym')
}
_wasm_dlsym.stub = true
...
function assignWasmExports(wasmExports) {
  ...
  _ntohs = wasmExports['$']
  _htons = wasmExports['aa']
  _htonl = wasmExports['ba']
  _emscripten_builtin_memalign = wasmExports['ca']
