...
const VALID_QUERY_PARAMS: Record<string, string[]> = {
  '/algorithms': ['highlight', 'tab', 'subtab', 'family', 'fn', 'level', 'q', 'compare'],
  '/timeline': ['country', 'region', 'q'],
  '/library': ['ref', 'q', 'cat', 'org', 'ind', 'view', 'sort'],
  '/threats': ['industry', 'id', 'criticality', 'q', 'sort', 'dir'],
  '/compliance': [
    'q',
    'cert',
    'tab',
  ...
  '/migrate': ['q', 'industry', 'layer', 'cat', 'step', 'verification', 'sort', 'mode', 'subcat'],
  '/assess': ['step'],
  '/playground': ['algo', 'tab'],
  '/playground/interactive': ['tab', 'algo'],
  '/openssl': ['cmd'],
  '/leaders': ['leader', 'sector', 'region', 'country', 'cat', 'q', 'sort', 'view'],
  '/learn': [],
  '/learn/': ['tab', 'step', 'category', 'diveDeeper'],
  '/learn/quiz': ['category'],
}
