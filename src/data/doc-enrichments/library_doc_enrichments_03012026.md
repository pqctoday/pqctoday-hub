...
- **Main Topic**: NIST publishes final post-quantum cryptographic standards for federal systems.
...
- **Main Topic**: Quantum-readiness roadmap for global financial systems.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: Global; Bodies: BIS, Central Banks
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: 2025-01-01
- **Document Status**: Published
- **Main Topic**: EU NIS Cooperation Group publishes coordinated roadmap for PQC transition across EU member states.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: EU member states; Bodies: EU Commission, NIS Cooperation Group
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Document Status**: Published
- **Main Topic**: India DST Task Force publishes phased roadmap for migration to post-quantum cryptography under National Quantum Mission (NQM).
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: Harvest Now, Decrypt Later (HNDL), Shor’s Algorithm
- **Migration Timeline Info**: Milestones: 2027: CII foundations | 2028: High-priority systems | 2029: Full CII | 2033: Nationwide implementation
- **Applicable Regions / Bodies**: Regions: India; Bodies: DST, NQM, C-DOT, DSCI
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
...
- **Document Status**: Published
- **Main Topic**: HKMA Fintech Promotion Blueprint (From Adoption to Advancement) — Quantum Preparedness Index
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: Hong Kong; Bodies: Hong Kong Legislative Council
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Document Status**: Published
- **Main Topic**: Dubai Electronic Security Center launches Post-Quantum Cryptography Guideline
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: United Arab Emirates; Bodies: Dubai Electronic Security Center
- **Leaders Contributions Mentioned**: H.E. Yousuf Hamad Al Shaibani, Chief Executive of the Dubai Electronic Security Center
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
...
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: Singapore; Bodies: IMDA, Cyber Security Agency of Singapore (CSA), Government Technology Agency of Singapore (GovTech)
- **Leaders Contributions Mentioned**: Mr. Heng Swee Keat (Singapore’s Deputy Prime Minister) announced the NQSN+ at ATxSG 2023
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
