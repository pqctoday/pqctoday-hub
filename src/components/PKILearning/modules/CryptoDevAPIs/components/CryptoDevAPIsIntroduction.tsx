    ...
    <div className="space-y-6">
      ...
      <div data-section-id="landscape" className="scroll-mt-20">
        ...
        >
          ...
          <p className="text-muted-foreground">
            These APIs are not interchangeable — they reflect different design philosophies,
            security models, and deployment targets. Understanding their relationships helps you
            choose correctly and design for crypto agility.
          </p>
      ...
      <div data-section-id="jca-bc" className="scroll-mt-20">
        ...
        >
          ...
          <p className="text-muted-foreground">
            ...
            registered via{' '}
            <code className="text-primary font-mono text-sm">Security.addProvider()</code>), and as
            a standalone lightweight API for environments where JCA overhead is undesirable. BC has
            had full ML-KEM, ML-DSA, SLH-DSA, and FN-DSA support since version 1.78.
          </p>
          <p className="text-muted-foreground">
      ...
      <div data-section-id="pkcs11" className="scroll-mt-20">
        ...
        >
          <p className="text-muted-foreground">
            <strong className="text-foreground">PKCS#11</strong> is a C API standard for
            communicating with cryptographic tokens (HSMs, smart cards, TPMs). The key objects are
            Slots, Tokens, and Sessions. Operations follow the pattern:{' '}
          ...
          <div className="bg-status-warning/10 border border-status-warning/40 rounded-lg p-3">
            ...
            <p className="text-sm text-muted-foreground">
              PKCS#11 sessions are mandatory — unlike JCA or OpenSSL, every operation requires an
      ...
      <div data-section-id="cng" className="scroll-mt-20">
        ...
        >
          <p className="text-muted-foreground">
            ...
            <code className="text-primary font-mono text-sm">BCryptOpenAlgorithmProvider</code>)
            from key storage providers (
