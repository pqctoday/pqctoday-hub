...
export const NetworkSecurityIntroduction: React.FC<NetworkSecurityIntroductionProps> = ({
  ...
  return (
    <div className="space-y-8 w-full">
      ...
      <div data-section-id="pqc-network-impact" className="scroll-mt-20">
        <CollapsibleSection
      ...
      <div data-section-id="tls-inspection-pqc" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <p>
            ...
            stress every assumption in inspection pipelines: buffer sizes, certificate parsing
            logic, hardware offload capacity, and session reassembly.
          </p>
      ...
      <div data-section-id="ids-ips-migration" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <p>
            ...
            detect certificate size anomalies, and identify downgrade attacks targeting the
            classical component of hybrid key exchanges.
          </p>
      ...
      <div data-section-id="vendor-roadmaps" className="scroll-mt-20">
        <CollapsibleSection
          icon={<Map size={24} className="text-primary" />}
          title="Cisco, Palo Alto, Fortinet, Juniper Migration Timelines"
        >
          <p>
            The four dominant enterprise NGFW vendors are at varying stages of PQC adoption.
            Planning infrastructure upgrades requires understanding not just current capabilities
            but the firmware and hardware upgrade paths required for full PQC TLS inspection
            support.
          </p>
      ...
      <div data-section-id="zero-trust-pqc" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <p>
            ...
            <InlineTooltip term="ZTNA">ZTNA</InlineTooltip> components that rely on classical PKI
            for authentication are vulnerable to harvest-now-decrypt-later (HNDL) attacks — making
            quantum-safe migration a priority for zero trust frameworks.
          </p>

          <div className="bg-muted/50 rounded-lg p-4 border border-border">
            <div className="text-sm font-bold text-foreground mb-3">
              ZTNA PQC Migration Priority
            </div>
          ...
          <div className="bg-muted/50 rounded-lg p-4 border border-border">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              with CNSA 2.0 timelines (hybrid by 2026, exclusively PQC by 2033 for NSS
              environments).
            </p>
          </div>
        </CollapsibleSection>
