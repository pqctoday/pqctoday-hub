...
export const DataAssetIntroduction: React.FC<DataAssetIntroductionProps> = ({
  ...
  return (
    <div className="space-y-8 w-full">
      ...
      <div data-section-id="classification" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          ...
          <div className="bg-muted/30 rounded-lg p-4 border border-border">
            <p className="text-xs text-muted-foreground">
              <strong className="text-foreground">Asset type also matters:</strong> Key material
              (root CA keys, HSM-protected secrets) should always be classified{' '}
              <span className="text-status-error font-bold">Critical</span> regardless of
              sensitivity tier — even if the data it protects is Medium. Keys are the root of trust
      ...
      <div data-section-id="compliance" className="scroll-mt-20">
        <CollapsibleSection
      ...
      <div data-section-id="methodology" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            <strong className="text-foreground">Which to use?</strong> Most organizations use NIST
            RMF if they are US federal contractors, ISO 27005 if they hold ISO 27001 certification,
            FAIR if they need board-level financial justification, and DORA/NIS2 if they are in
            scope for EU regulation. For a hands-on deep dive applying all four frameworks to your
            assets, see the <strong>PQC Risk Management</strong> module.
          </p>
        </CollapsibleSection>
      </div>
