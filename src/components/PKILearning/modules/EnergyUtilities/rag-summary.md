...
- **NERC-CIP compliance**: CIP-002 (BES Cyber System categorization — High/Medium/Low impact), CIP-007 (system security management — patch management and port/service management), CIP-011 (information protection — encryption of BES Cyber System Information). PQC migration must be reflected in NERC-CIP compliance documentation and approved by grid operator; unilateral algorithm changes in BCS without documented CSMS update are a compliance violation.
...
- NERC CIP-002, CIP-007, CIP-011 — Bulk Electric System Cybersecurity Standards
