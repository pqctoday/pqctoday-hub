...
export const Introduction: React.FC<IntroductionProps> = ({ onNavigateToWorkshop }) => {
  return (
    <div className="space-y-8 w-full">
      ...
      <div data-section-id="tee-fundamentals" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <div className="space-y-4 text-sm text-foreground/80">
            <p>
              ...
              integrity of code and data loaded inside it. Unlike traditional OS-level isolation,
              TEEs protect workloads even when the operating system, hypervisor, or firmware has
            ...
            <div className="bg-muted/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                smaller TCB means fewer components can undermine security. Process-level TEEs (SGX)
                have the smallest TCB &mdash; just the CPU and enclave code. VM-level TEEs (TDX,
                SEV-SNP) include the guest OS, resulting in a larger but more practical TCB.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="bg-muted/50 rounded-lg p-3 border border-border">
                ...
                <p className="text-xs text-muted-foreground mb-2">
                  Encrypted in memory while being processed. TEEs provide hardware-enforced
                  isolation so data remains protected during computation.
                </p>
      ...
      <div data-section-id="vendor-architectures" className="scroll-mt-20">
        <CollapsibleSection
      ...
      <div data-section-id="attestation" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <div className="space-y-4 text-sm text-foreground/80">
            <p>
              ...
              platform state, and configuration &mdash; enabling a relying party to verify that it
              is communicating with genuine, untampered hardware before releasing sensitive data.
            </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    signing attestation reports. Shor&apos;s algorithm can break these signatures in
      ...
      <div data-section-id="memory-encryption" className="scroll-mt-20">
        <CollapsibleSection
          ...
          <div className="space-y-4 text-sm text-foreground/80">
            ...
            <div className="bg-muted/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                and/or signer identity). Enclaves use sealing keys to encrypt data that persists
                across restarts &mdash; only an enclave with the same identity on the same physical
                platform can unseal the data. The key derivation chain typically flows:{' '}
                <span className="font-mono text-primary">
                  CPU Root Key &rarr; CPU SVN &rarr; Enclave Identity &rarr; Sealing Key
                </span>
                . If any component in the chain changes (firmware update, different enclave
                version), the derived sealing key changes and previously sealed data becomes
                inaccessible without a migration protocol.
              </p>
            </div>
      ...
      <div data-section-id="tee-hsm" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <div className="space-y-4 text-sm text-foreground/80">
            <p>
              In production deployments, TEEs rarely operate in isolation &mdash; they need access
              to long-lived cryptographic keys stored in Hardware Security Modules (HSMs). The
            ...
            <div className="bg-muted/50 rounded-lg p-4 border border-border">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 text-xs font-mono text-foreground justify-center">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <ArrowRight
                    size={14}
                    className="text-muted-foreground sm:rotate-180 -rotate-90"
                  />
                </div>
                <div className="bg-status-success/10 border border-status-success/30 rounded px-4 py-2 text-center font-bold">
                  HSM
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-muted/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-xs text-muted-foreground mb-2">
                  ...
                  code measurement, and validates the TCB level before releasing any key material.
                </p>
                <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    operations &mdash; the same operations used in TEE-HSM key provisioning flows.
                  </p>
                  <Link
      ...
      <div data-section-id="quantum-threats" className="scroll-mt-20">
        <CollapsibleSection
        ...
        >
          <div className="space-y-4 text-sm text-foreground/80">
            <p>
              ...
              from attestation signatures to memory encryption to TEE-HSM communication channels.
              The severity and migration urgency varies by component.
            </p>
