              ...
              <div className="mt-5 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    ...
                    compliance teams &mdash; ROI calculators, RACI builders, vendor scorecards,
                    policy generators, deployment playbooks, and audit checklists &mdash; all
                    adapting to your industry, geography, and regulatory context.
                  </p>
