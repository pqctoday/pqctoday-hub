      ...
      activities: [
        {
          ...
          steps: [
            {
              kind: 'recurrence',
              label: 'Re-run the crypto vulnerability watch in a later quarter (drift detection)',
              to: '/business/tools/crypto-vulnerability-watch',
            ...
            {
              kind: 'reference',
              label: 'Reference: the product estate the re-run inventory is measured against',
              to: '/migrate',
              refId: 'migrate',
            },
          ],
