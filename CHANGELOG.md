...
- **Patents data refresh**: replaced `patents_04262026_r2`, `patents_05012026`,
  `patents_05022026` with `patents_05022026_r2` + `patents_05032026`. PatentDetail
  and PatentsTable updated for the new schema.
- **CuriousSummaryBanner.tsx** rework (~116 lines reorganised).
- **Infographics regeneration**: ~50 NotebookLM-generated `nllm_*.jpg` infographics
  removed; replaced with `pqcstd_*.png` set generated by the new pqctoday-standard
  pipeline. ~50 modules covered.
- **MainLayout.tsx** trimmed (-6 lines).
- **PageAccuracyFeedback.tsx** removed (UI no longer surfaces this widget).
